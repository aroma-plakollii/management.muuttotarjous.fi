...
import { addCustomPrice } from "../../../../services/movingServiceServices/companyServices/CustomPriceService";
...
const CreateCustomPrice = () => {
    ...
    useEffect(() => {
        const __init = async () => {
            ...
            setState({...state, company, products, companyId, loading: false})
        }
    ...
    const onCreate = async () => {
        ...
        if (
            !state.customPrice.product_id ||
            !state.customPrice.date ||
        ...
        if (!state.hasError){
            ...
            const res = await addCustomPrice(data);
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <select disabled className={`form-control`} name="company_id" id="company_id"
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <select className={`form-control ${state.hasError && !state.customPrice.product_id ? 'is-invalid' : ''}`} name="product_id" id="product_id"
                                    ...
                                    <div className="form-group row">
                                        <label htmlFor="name" className="col-sm-3 col-form-label">Price</label>
                                        <div className="col-sm-9">
                                            <input type="text" className={`form-control ${state.hasError && !state.customPrice.price ? 'is-invalid' : ''}`} id="price"
