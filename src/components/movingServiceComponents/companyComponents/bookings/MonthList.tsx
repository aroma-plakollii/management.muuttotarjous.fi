...
import {getBookingsByMonth} from "../../../../services/movingServiceServices/companyServices/BookingService";
                ...
                <div className={'row'}>
                    <div className={'col-md-12'}>
                        <div className={'d-flex align-items-center p-2'}>
                            ...
                            <Link to={'/booking/add-a-job'} className="btn btn-primary ml-5 mr-2">Add a job</Link>
                            <Link to={'/booking/add-a-block'} className="btn btn-primary">Add a block</Link>
                        </div>
                    </div>
                </div>
            </div>
