...
import {changeStatus} from "../../../../services/movingServiceServices/companyServices/BookingService";
                ...
                <div className={'container-fluid'}>
                    <div className={'row'}>
                        <div className={'col-md-1'}>
                            {
                                !props.booking.progress_status &&
                                <i style={{cursor: 'pointer'}}
                                   className="fas fa-ban text-danger"></i>
                            }
                            {
                        ...
                        <div className={'col-md-2'}>
                            {getDate(props.booking.start_date)} <span style={{color: "gray"}}> {`${getStartTime(props.booking.start_date)} - ${getEndTime(props.booking.start_date)}`} </span>
                        ...
                        <div className={'col-md-1 text-end'}>
                            ...
                            <Link to={`/booking/extra-service/${props.booking.id}`} className="fas fa-plus text-muted"></Link>
                        </div>
                    </div>
