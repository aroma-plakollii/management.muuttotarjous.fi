...
import { getUserDetails, saveUserDetails } from "../../../../services/movingServiceServices/adminServices/UserService";
import {getRoles} from "../../../../services/movingServiceServices/adminServices/UserService";
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <select
                                                    ...
                                                    value={state.userDetails.ms_company_id}
                                                >
