...
import {getUsers, deleteUser, getRoles} from "../../../../services/movingServiceServices/adminServices/UserService";
                                        ...
                                        <tbody>
                                            {
                                                state.users.map((user: any) => {
                                                    ...
                                                    const company = state.companies.find((company) => company.id === user.ms_company_id);
