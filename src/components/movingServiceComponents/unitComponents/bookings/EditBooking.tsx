...
import { getBookingDetails } from "../../../../services/movingServiceServices/unitServices/BookingService";
import { getCompanyDetails } from "../../../../services/movingServiceServices/unitServices/CompaniesService";
import { getUnitsByCompany } from "../../../../services/movingServiceServices/unitServices/UnitService";
import { getProducts } from "../../../../services/movingServiceServices/unitServices/ProductsService";
import { saveBookingDetails, getExtraServices } from "../../../../services/movingServiceServices/unitServices/BookingService";
import { Booking } from "../../../../interfaces/movingServiceInterfaces/unitInterfaces/IBooking";
import {Company} from "../../../../interfaces/movingServiceInterfaces/unitInterfaces/ICompany";
import {Unit} from "../../../../interfaces/movingServiceInterfaces/unitInterfaces/IUnit";
import {Product} from "../../../../interfaces/movingServiceInterfaces/unitInterfaces/IProduct";
import {IExtraService} from "../../../../interfaces/movingServiceInterfaces/unitInterfaces/IExtraService";
...
const EditBooking = () => {
    const [state, setState] = useState({
        ...
        start_address_description: '',
        end_address_description: '',
        hasError: false,
        loading: true,
    });
    ...
    const renderUnits = () => {
        return (
            state.units.map((unit: any) => (
                <option value={unit.id} key={unit.id}>{unit.capacity}</option>            
            ))
        );
    }
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <DatePicker
                                                className={'form-control'}
                                                onChange={(val: any) => onDateChange('end_date', val)}
                                                onSelect={(val: any) => onDateChange('end_date', val)}
