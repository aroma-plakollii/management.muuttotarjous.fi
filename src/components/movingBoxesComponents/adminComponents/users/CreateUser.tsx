...
import {createUser, getRoles} from "../../../../services/movingBoxesServices/adminServices/UserService";
    ...
    const onCreate = async () => {
        ...
        if (!state.hasError){
            const data = {
                ...
                mb_company_id: state.user.mb_company_id,
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <select
                                                    ...
                                                    value={service ? service.toString() : 'boxes-service'}
                                                >
                                                    <option value={'boxes-service'}>Boxes Service</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <select
                                                    ...
                                                    value={state.user.mb_company_id}
                                                >
