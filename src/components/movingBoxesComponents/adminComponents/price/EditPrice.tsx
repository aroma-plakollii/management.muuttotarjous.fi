...
import {addPrice, getPriceDetails, savePriceDetails} from "../../../../services/movingBoxesServices/adminServices/PricesService";
...
const EditPrice = () => {
    ...
    useEffect(() => {
        const __init = async () => {
            ...
            setState({...state, priceDetails: price, companies: companies})
        }
                            ...
                            <div className="form-horizontal">
                                <div className="card-body">
                                    <div className="form-group row">
                                        <label htmlFor="business_number" className="col-sm-3 col-form-label">Companies</label>
                                        <div className="col-sm-9">
                                            <select className={`form-control ${state.hasError && !state.priceDetails.company_id ? 'is-invalid' : ''}`} name="companies" id="companies"
                                                    onChange={(val: any) => onInputChange('company_id', val)}  value={state.priceDetails.company_id}>
